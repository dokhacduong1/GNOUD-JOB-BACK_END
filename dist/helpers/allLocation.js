...
exports.Coordinate = exports.detailedAddress = exports.areaDetails = void 0;
...
function detailedAddress(ward, district, city, input) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const url = process.env.AUTOCOMPLETE + district_C + component_C + ward_C + input_C + sessiontoken_C + state_C + use_case_C + v_C;
...
function Coordinate(placeid) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const url = process.env.DETAILS_LOCATION + component_C + fields_C + group_C + placeid_C + sessiontoken_C + use_case_C + v_C;
            const { data } = yield axios_1.default.get(url);
            return data || [];
        }
        catch (error) {
