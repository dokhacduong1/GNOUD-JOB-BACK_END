...
const uploadToImgur = __importStar(require("../../../../helpers/uploadToImgur"));
const uplloadReact = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.body["thumbUrl"]) {
        try {
            ...
            const link = yield uploadToImgur.uploadSingle(buffer);
...
const uplloadTiny = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (req["file"]) {
        try {
            const link = yield uploadToImgur.uploadSingle(req["file"].buffer);
